...
__PACKAGE__
    ->mk_scalar_accessors(qw(mutex_key))
...
Data::Conveyor::App::Mutex inherits from
...
This document describes version 0.02 of L<Data::Conveyor::App::Mutex>.
