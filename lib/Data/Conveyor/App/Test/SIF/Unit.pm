...
=head1 SYNOPSIS
    ...
    Data::Conveyor::App::Test::SIF::Unit->new;
...
Data::Conveyor::App::Test::SIF::Unit inherits from
...
methods and functions:
    ...
    execute_test_def(), exists_test_def(), expect(), expect_clear(),
    keys_test_def(), make_plan(), named_test(), plan_test(),
    read_test_defs(), run_num(), run_num_clear(), runs(), runs_clear(),
    should_skip(), should_skip_testname(), test_def(), test_def_clear(),
...
This document describes version 0.02 of L<Data::Conveyor::App::Test::SIF::Unit>.
