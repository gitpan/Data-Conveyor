package Data::Conveyor::Charset::ASCII;

# $Id: ASCII.pm 8417 2005-02-16 16:57:57Z gr $
...
sub is_valid_string {
    my ($self, $string) = @_;
    return 0 unless $self->SUPER::is_valid_string($string);
...
Data::Conveyor::Charset::ASCII - stage-based conveyor-belt-like ticket handling system

=head1 SYNOPSIS

    Data::Conveyor::Charset::ASCII->new;
...
Data::Conveyor::Charset::ASCII inherits from L<Data::Conveyor::Charset>.
...
This document describes version 0.02 of L<Data::Conveyor::Charset::ASCII>.
