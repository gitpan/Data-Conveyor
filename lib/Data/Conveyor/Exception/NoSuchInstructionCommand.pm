package Data::Conveyor::Exception::NoSuchInstructionCommand;

# $Id: NoSuchInstructionCommand.pm 13653 2007-10-22 09:11:20Z gr $
...
use constant default_message => 'No such instruction command [%s]';
...
Data::Conveyor::Exception::NoSuchInstructionCommand - stage-based conveyor-belt-like ticket handling system

=head1 SYNOPSIS

    Data::Conveyor::Exception::NoSuchInstructionCommand->new;
...
Data::Conveyor::Exception::NoSuchInstructionCommand inherits from
...
This document describes version 0.02 of L<Data::Conveyor::Exception::NoSuchInstructionCommand>.
