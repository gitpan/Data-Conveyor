...
# $Id: NoSuchLockType.pm 13653 2007-10-22 09:11:20Z gr $
...
=head1 SYNOPSIS
    ...
    Data::Conveyor::Exception::NoSuchLockType->new;
...
=item lock_type
    ...
    my $value = $obj->lock_type;
    $obj->lock_type($value);

A basic getter/setter method. If called without an argument, it returns the
value. If called with a single argument, it sets the value.

=item lock_type_clear
...
Data::Conveyor::Exception::NoSuchLockType inherits from
...
This document describes version 0.02 of L<Data::Conveyor::Exception::NoSuchLockType>.
