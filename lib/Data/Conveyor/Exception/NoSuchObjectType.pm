package Data::Conveyor::Exception::NoSuchObjectType;

# $Id: NoSuchObjectType.pm 13653 2007-10-22 09:11:20Z gr $
...
__PACKAGE__->mk_scalar_accessors(qw(object_type));


use constant default_message => 'No such object type [%s]';
use constant PROPERTIES      => ( 'object_type' );
...
Data::Conveyor::Exception::NoSuchObjectType - stage-based conveyor-belt-like ticket handling system

=head1 SYNOPSIS

    Data::Conveyor::Exception::NoSuchObjectType->new;
...
Data::Conveyor::Exception::NoSuchObjectType inherits from
L<Class::Scaffold::Exception::Business> and
...
This document describes version 0.03 of L<Data::Conveyor::Exception::NoSuchObjectType>.
