package Data::Conveyor::Exception::Template;

# $Id: Template.pm 13653 2007-10-22 09:11:20Z gr $
...
__PACKAGE__->mk_scalar_accessors(qw(template));


use constant default_message => 'Error in template [%s]';
use constant PROPERTIES      => ( 'template' );
...
Data::Conveyor::Exception::Template - stage-based conveyor-belt-like ticket handling system

=head1 SYNOPSIS

    Data::Conveyor::Exception::Template->new;
...
Data::Conveyor::Exception::Template inherits from
L<Class::Scaffold::Exception::Business>.
...
This document describes version 0.03 of L<Data::Conveyor::Exception::Template>.
