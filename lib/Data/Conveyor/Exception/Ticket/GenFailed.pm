...
# $Id: GenFailed.pm 13653 2007-10-22 09:11:20Z gr $
...
=head1 SYNOPSIS
    ...
    Data::Conveyor::Exception::Ticket::GenFailed->new;
...
Data::Conveyor::Exception::Ticket::GenFailed inherits from
...
This document describes version 0.03 of L<Data::Conveyor::Exception::Ticket::GenFailed>.
