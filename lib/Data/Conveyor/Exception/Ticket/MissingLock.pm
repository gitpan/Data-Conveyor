...
# $Id: MissingLock.pm 13653 2007-10-22 09:11:20Z gr $
...
=head1 SYNOPSIS
    ...
    Data::Conveyor::Exception::Ticket::MissingLock->new;
...
Data::Conveyor::Exception::Ticket::MissingLock inherits from
...
This document describes version 0.02 of L<Data::Conveyor::Exception::Ticket::MissingLock>.
