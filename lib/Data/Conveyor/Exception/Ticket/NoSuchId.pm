...
# $Id: NoSuchId.pm 13653 2007-10-22 09:11:20Z gr $
...
=head1 SYNOPSIS
    ...
    Data::Conveyor::Exception::Ticket::NoSuchId->new;
...
Data::Conveyor::Exception::Ticket::NoSuchId inherits from
...
functions:
    ...
    delete_storage_info(), exists_storage_info(), keys_storage_info(),
    storage(), storage_info(), storage_info_clear(), storage_info_delete(),
...
This document describes version 0.03 of L<Data::Conveyor::Exception::Ticket::NoSuchId>.
