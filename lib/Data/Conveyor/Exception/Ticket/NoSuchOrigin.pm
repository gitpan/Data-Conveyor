package Data::Conveyor::Exception::Ticket::NoSuchOrigin;

# $Id: NoSuchOrigin.pm 13653 2007-10-22 09:11:20Z gr $
...
__PACKAGE__->mk_scalar_accessors(qw(origin));


use constant default_message => 'No such ticket origin [%s]';
use constant PROPERTIES      => ( 'origin' );
...
Data::Conveyor::Exception::Ticket::NoSuchOrigin - stage-based conveyor-belt-like ticket handling system

=head1 SYNOPSIS

    Data::Conveyor::Exception::Ticket::NoSuchOrigin->new;
...
Data::Conveyor::Exception::Ticket::NoSuchOrigin inherits from
L<Data::Conveyor::Exception::Ticket> and L<Class::Value::Exception::Base>.
...
This document describes version 0.03 of L<Data::Conveyor::Exception::Ticket::NoSuchOrigin>.
