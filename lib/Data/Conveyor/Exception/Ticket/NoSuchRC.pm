...
# $Id: NoSuchRC.pm 13653 2007-10-22 09:11:20Z gr $
...
=head1 SYNOPSIS
    ...
    Data::Conveyor::Exception::Ticket::NoSuchRC->new;
...
Data::Conveyor::Exception::Ticket::NoSuchRC inherits from
...
This document describes version 0.02 of L<Data::Conveyor::Exception::Ticket::NoSuchRC>.
