package Data::Conveyor::Exception::Ticket::NoSuchType;
...
use constant default_message => 'No such ticket type [%s]';
...
Data::Conveyor::Exception::Ticket::NoSuchType - stage-based conveyor-belt-like ticket handling system

=head1 SYNOPSIS

    Data::Conveyor::Exception::Ticket::NoSuchType->new;
...
Data::Conveyor::Exception::Ticket::NoSuchType inherits from
...
This document describes version 0.03 of L<Data::Conveyor::Exception::Ticket::NoSuchType>.
