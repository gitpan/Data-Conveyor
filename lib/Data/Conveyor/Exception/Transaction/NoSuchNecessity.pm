package Data::Conveyor::Exception::Transaction::NoSuchNecessity;

# $Id: NoSuchNecessity.pm 13653 2007-10-22 09:11:20Z gr $
...
use base qw(
    Data::Conveyor::Exception::Transaction
    Class::Value::Exception::Base
);


__PACKAGE__->mk_scalar_accessors(qw(necessity));


use constant default_message => 'No such transaction necessity [%s]';
use constant PROPERTIES      => ( 'necessity' );
...
Data::Conveyor::Exception::Transaction::NoSuchNecessity - stage-based conveyor-belt-like ticket handling system

=head1 SYNOPSIS

    Data::Conveyor::Exception::Transaction::NoSuchNecessity->new;
...
=item necessity
    ...
    my $value = $obj->necessity;
    $obj->necessity($value);

A basic getter/setter method. If called without an argument, it returns the
value. If called with a single argument, it sets the value.

=item necessity_clear
...
Data::Conveyor::Exception::Transaction::NoSuchNecessity inherits from
L<Data::Conveyor::Exception::Transaction> and
...
This document describes version 0.02 of L<Data::Conveyor::Exception::Transaction::NoSuchNecessity>.
