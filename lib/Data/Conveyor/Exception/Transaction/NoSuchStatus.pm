package Data::Conveyor::Exception::Transaction::NoSuchStatus;

# $Id: NoSuchStatus.pm 13653 2007-10-22 09:11:20Z gr $
...
use constant default_message => 'No such transaction status [%s]';
...
Data::Conveyor::Exception::Transaction::NoSuchStatus - stage-based conveyor-belt-like ticket handling system

=head1 SYNOPSIS

    Data::Conveyor::Exception::Transaction::NoSuchStatus->new;
...
Data::Conveyor::Exception::Transaction::NoSuchStatus inherits from
...
This document describes version 0.03 of L<Data::Conveyor::Exception::Transaction::NoSuchStatus>.
