package Data::Conveyor::Exception::Transaction::NoSuchType;

# $Id: NoSuchType.pm 13653 2007-10-22 09:11:20Z gr $
...
__PACKAGE__->mk_scalar_accessors(qw(type));


use constant default_message => 'No such transaction type [%s]';
use constant PROPERTIES      => ( 'type' );
...
Data::Conveyor::Exception::Transaction::NoSuchType - stage-based conveyor-belt-like ticket handling system

=head1 SYNOPSIS

    Data::Conveyor::Exception::Transaction::NoSuchType->new;
...
Data::Conveyor::Exception::Transaction::NoSuchType inherits from
...
This document describes version 0.02 of L<Data::Conveyor::Exception::Transaction::NoSuchType>.
