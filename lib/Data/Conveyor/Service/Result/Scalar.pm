...
=head1 SYNOPSIS
    ...
    Data::Conveyor::Service::Result::Scalar->new;
...
Data::Conveyor::Service::Result::Scalar inherits from
...
functions:
    ...
    is_ok(), result(), result_clear(), stringify()
...
This document describes version 0.02 of L<Data::Conveyor::Service::Result::Scalar>.
