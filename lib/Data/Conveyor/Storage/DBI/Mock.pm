...
=head1 SYNOPSIS
    ...
    Data::Conveyor::Storage::DBI::Mock->new;
...
Data::Conveyor::Storage::DBI::Mock inherits from
L<Data::Conveyor::Storage::DBI> and L<Data::Storage::DBI::Mock>.
...
The superclass L<Data::Storage::DBI::Mock> defines these methods and
functions:
...
The superclass L<Data::Storage> defines these methods and functions:
    ...
    clear_log(), create(), id(), initialize_data(), lazy_connect(),
    log_clear(), rollback_mode_clear(), rollback_mode_set(), setup(),
    signature(), test_setup()
...
This document describes version 0.03 of L<Data::Conveyor::Storage::DBI::Mock>.
