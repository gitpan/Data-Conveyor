...
=head1 SYNOPSIS
    ...
    Data::Conveyor::Storage::DBI::Postgres->new;
...
Data::Conveyor::Storage::DBI::Postgres inherits from
L<Data::Conveyor::Storage::DBI> and L<Data::Storage::DBI::Postgres>.
...
The superclass L<Data::Storage::DBI::Postgres> defines these methods and
functions:

    connect(), last_id(), next_id(), rewrite_query_for_dbd(), test_setup(),
    trace()
...
The superclass L<Data::Storage> defines these methods and functions:
    ...
    rollback_mode_clear(), rollback_mode_set(), setup()
