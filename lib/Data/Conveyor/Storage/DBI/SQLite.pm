...
# $Id: SQLite.pm 9189 2005-06-14 14:47:27Z gr $
...
=head1 SYNOPSIS
    ...
    Data::Conveyor::Storage::DBI::SQLite->new;
...
Data::Conveyor::Storage::DBI::SQLite inherits from
L<Data::Storage::DBI::SQLite> and L<Data::Conveyor::Storage::DBI>.

The superclass L<Data::Storage::DBI::SQLite> defines these methods and
functions:

    connect_string(), last_id(), test_setup()
