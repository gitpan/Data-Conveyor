package Data::Conveyor::Storage::DBI::Sybase;

# $Id: Sybase.pm 9501 2005-06-29 23:34:04Z ac $
...
Data::Conveyor::Storage::DBI::Sybase - stage-based conveyor-belt-like ticket handling system

=head1 SYNOPSIS

    Data::Conveyor::Storage::DBI::Sybase->new;
...
Data::Conveyor::Storage::DBI::Sybase inherits from
L<Data::Conveyor::Storage::DBI> and L<Data::Storage::DBI::Sybase>.

The superclass L<Data::Conveyor::Storage::DBI> defines these methods and
functions:

    clear_idcache(), idcache(), idcache_clear(), ticket_handle_exception(),
    ticket_insert(), ticket_update()
...
The superclass L<Data::Storage::DBI::Sybase> defines these methods and
functions:

    clear_dbserver(), connect_string(), dbserver(), dbserver_clear(),
    get_connect_options()
...
The superclass L<Data::Storage> defines these methods and functions:
    ...
    clear_log(), create(), id(), initialize_data(), log_clear(),
    rollback_mode_clear(), rollback_mode_set(), setup(), test_setup()
...
This document describes version 0.02 of L<Data::Conveyor::Storage::DBI::Sybase>.
