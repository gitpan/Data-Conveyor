...
# $Id: Factory.pm 11479 2006-05-22 20:53:17Z gr $
...
=head1 SYNOPSIS
    ...
    Data::Conveyor::Template::Factory->new;
...
Data::Conveyor::Template::Factory inherits from
L<Class::Scaffold::Factory>.

The superclass L<Class::Scaffold::Factory> defines these methods and
functions:

    get_class_name_for_handler(), notify_lookup_failure()
...
This document describes version 0.02 of L<Data::Conveyor::Template::Factory>.
