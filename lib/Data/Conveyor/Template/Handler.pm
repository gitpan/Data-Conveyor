package Data::Conveyor::Template::Handler;

# $Id: Handler.pm 13653 2007-10-22 09:11:20Z gr $
#
# All template handlers should subclass this class, which acts as a marker
# class and also has a ticket (though that may not be used in the actual
# template handlers) because the template factory passes the ticket object to
# the handler objects it generates.
...
Data::Conveyor::Template::Handler - stage-based conveyor-belt-like ticket handling system

=head1 SYNOPSIS

    Data::Conveyor::Template::Handler->new;
...
Data::Conveyor::Template::Handler inherits from
