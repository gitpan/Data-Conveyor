...
# $Id: Inherited.pm 11422 2006-05-08 15:31:22Z gr $
...
=head1 SYNOPSIS
    ...
    Data::Conveyor::Test::Inherited->new;
...
Data::Conveyor::Test::Inherited inherits from
L<Class::Scaffold::Test::Inherited>.

The superclass L<Class::Scaffold::Test::Inherited> defines these methods
and functions:

    INHERITED_TEST_CLASSES(), get_inherited_test_classes()
