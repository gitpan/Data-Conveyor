...
# $Id: Test.pm 13653 2007-10-22 09:11:20Z gr $
...
=head1 SYNOPSIS
    ...
    Data::Conveyor::Ticket::Dispatcher::Test->new;
...
Data::Conveyor::Ticket::Dispatcher::Test inherits from
L<Data::Conveyor::Ticket::Dispatcher>.

The superclass L<Data::Conveyor::Ticket::Dispatcher> defines these methods
and functions:

    clear_stage(), clear_transactional_authority(), dispatch(),
    set_transactional_authority(), stage(), stage_clear(), ticket(),
    ticket_clear(), ticket_exists(), transactional_authority(),
    transactional_authority_clear(), transactional_authority_set()
