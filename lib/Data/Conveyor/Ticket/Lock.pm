...
__PACKAGE__
    ->mk_scalar_accessors(qw(object_id))
    ->mk_boolean_accessors(qw(got))
...
Data::Conveyor::Ticket::Lock inherits from L<Class::Scaffold::Storable>.
...
This document describes version 0.02 of L<Data::Conveyor::Ticket::Lock>.
