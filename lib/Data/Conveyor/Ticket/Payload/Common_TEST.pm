...
=head1 SYNOPSIS
    ...
    Data::Conveyor::Ticket::Payload::Common_TEST->new;
...
Data::Conveyor::Ticket::Payload::Common_TEST inherits from
...
This document describes version 0.02 of L<Data::Conveyor::Ticket::Payload::Common_TEST>.
