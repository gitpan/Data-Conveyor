...
=head1 SYNOPSIS
    ...
    Data::Conveyor::Ticket::Payload::Instruction->new;
...
If called with an argument object of type Class::Value it sets the object; further
arguments are discarded. If called with arguments but the first argument is
not an object of type Class::Value, a new object of type Class::Value is constructed and the
arguments are passed to the constructor.

If called without arguments, it returns the Class::Value object stored in this slot;
if there is no such object, a new Class::Value object is constructed - no arguments
...
Data::Conveyor::Ticket::Payload::Instruction inherits from
...
This document describes version 0.02 of L<Data::Conveyor::Ticket::Payload::Instruction>.
