...
# $Id: Clear.pm 11537 2006-05-24 11:42:18Z gr $
...
=head1 SYNOPSIS
    ...
    Data::Conveyor::Ticket::Payload::Instruction::Clear->new;
...
Data::Conveyor::Ticket::Payload::Instruction::Clear inherits from
L<Data::Conveyor::Ticket::Payload::Instruction>.

The superclass L<Data::Conveyor::Ticket::Payload::Instruction> defines
these methods and functions:

    clear_value(), command(), command_clear(), command_exists(), eq(),
    value(), value_clear()
...
This document describes version 0.02 of L<Data::Conveyor::Ticket::Payload::Instruction::Clear>.
