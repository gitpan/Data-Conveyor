...
=head1 SYNOPSIS
    ...
    Data::Conveyor::Ticket::Payload::Instruction::Container->new;
...
Data::Conveyor::Ticket::Payload::Instruction::Container inherits from
L<Data::Container> and L<Class::Scaffold::Storable>.
...
This document describes version 0.03 of L<Data::Conveyor::Ticket::Payload::Instruction::Container>.
