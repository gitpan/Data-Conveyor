...
=head1 SYNOPSIS
    ...
    Data::Conveyor::Ticket::Payload::Instruction::Factory->new;
...
Data::Conveyor::Ticket::Payload::Instruction::Factory inherits from
L<Class::Scaffold::Factory>.

The superclass L<Class::Scaffold::Factory> defines these methods and
functions:

    gen_handler(), get_class_name_for_handler(), notify_lookup_failure()
...
This document describes version 0.02 of L<Data::Conveyor::Ticket::Payload::Instruction::Factory>.
