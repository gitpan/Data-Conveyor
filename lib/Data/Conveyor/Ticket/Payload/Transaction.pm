...
methods and functions:
    ...
    apply_instruction_container(), check(), clear_implicit(), data(),
    exception_container(), exception_container_clear(),
    exception_container_exists(), has_problematic_exceptions(), implicit(),
    implicit_clear(), implicit_set(), prepare_comparable(), rc(),
    set_implicit(), status()
...
This document describes version 0.02 of L<Data::Conveyor::Ticket::Payload::Transaction>.
