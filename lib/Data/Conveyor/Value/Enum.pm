...
Data::Conveyor::Value::Enum inherits from L<Class::Value::Enum> and
...
The superclass L<Class::Value::Enum> defines these methods and functions:
    ...
    get_value_normalization_hashref(), normalize_enum_value(),
    normalize_value()
...
This document describes version 0.03 of L<Data::Conveyor::Value::Enum>.
