...
# $Id: LockType.pm 8442 2005-02-17 17:16:09Z gr $
...
sub get_valid_values_list { $_[0]->delegate->LO }
...
=head1 SYNOPSIS
    ...
    Data::Conveyor::Value::LockType->new;
...
Data::Conveyor::Value::LockType inherits from
...
This document describes version 0.02 of L<Data::Conveyor::Value::LockType>.
