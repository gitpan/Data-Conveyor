package Data::Conveyor::Value::ObjectType;

# $Id: ObjectType.pm 8442 2005-02-17 17:16:09Z gr $
...
sub get_valid_values_list { $_[0]->delegate->OT }
...
sub send_notify_value_invalid {
    ...
    $self->exception_container->record(
        'Data::Conveyor::Exception::NoSuchObjectType',
        object_type => $value,
    );
}
...
Data::Conveyor::Value::ObjectType - stage-based conveyor-belt-like ticket handling system

=head1 SYNOPSIS

    Data::Conveyor::Value::ObjectType->new;
...
Data::Conveyor::Value::ObjectType inherits from
...
This document describes version 0.02 of L<Data::Conveyor::Value::ObjectType>.
