package Data::Conveyor::Value::Ticket::Origin;

# $Id: Origin.pm 8442 2005-02-17 17:16:09Z gr $
...
sub get_valid_values_list { $_[0]->delegate->OR }
...
sub send_notify_value_invalid {
    ...
    $self->exception_container->record(
        'Data::Conveyor::Exception::Ticket::NoSuchOrigin',
        origin => $value,
    );
}
...
Data::Conveyor::Value::Ticket::Origin - stage-based conveyor-belt-like ticket handling system

=head1 SYNOPSIS

    Data::Conveyor::Value::Ticket::Origin->new;
...
Data::Conveyor::Value::Ticket::Origin inherits from
...
This document describes version 0.03 of L<Data::Conveyor::Value::Ticket::Origin>.
