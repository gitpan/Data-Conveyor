...
# $Id: RC_TEST.pm 10704 2006-02-07 14:45:54Z gr $
...
sub run {
    ...
    $self->apply_rc_ok('RC_MANUAL' , 'RC_INTERNAL_ERROR' , 'RC_INTERNAL_ERROR', 1);
    ...
    $self->apply_rc_ok('RC_INTERNAL_ERROR' , 'RC_MANUAL'         , 'RC_INTERNAL_ERROR', 1);
    $self->apply_rc_ok('RC_INTERNAL_ERROR' , 'RC_INTERNAL_ERROR' , 'RC_INTERNAL_ERROR', 1);
...
=head1 SYNOPSIS
    ...
    Data::Conveyor::Value::Ticket::RC_TEST->new;
...
Data::Conveyor::Value::Ticket::RC_TEST inherits from
