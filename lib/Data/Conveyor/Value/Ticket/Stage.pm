...
=head1 SYNOPSIS
    ...
    Data::Conveyor::Value::Ticket::Stage->new;
...
Data::Conveyor::Value::Ticket::Stage inherits from L<Class::Value> and
...
The superclass L<Class::Value> defines these methods and functions:
    ...
    exception_container_clear(), init(), is_defined(), is_valid(),
    ...
    skip_checks(), skip_dirtying(), skip_normalizations(), str_cmp(),
    stringify(), throw_single_exception(), value()
