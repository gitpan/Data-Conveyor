...
=head1 SYNOPSIS
    ...
    Data::Conveyor::Value::Ticket::Status->new;
...
Data::Conveyor::Value::Ticket::Status inherits from
...
This document describes version 0.03 of L<Data::Conveyor::Value::Ticket::Status>.
