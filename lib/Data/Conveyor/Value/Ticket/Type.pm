...
sub get_valid_values_list { $_[0]->delegate->TT }
...
Data::Conveyor::Value::Ticket::Type - stage-based conveyor-belt-like ticket handling system

=head1 SYNOPSIS

    Data::Conveyor::Value::Ticket::Type->new;
...
Data::Conveyor::Value::Ticket::Type inherits from
...
This document describes version 0.02 of L<Data::Conveyor::Value::Ticket::Type>.
