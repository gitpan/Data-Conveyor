...
Data::Conveyor::Value::Transaction::Necessity - stage-based conveyor-belt-like ticket handling system

=head1 SYNOPSIS

    Data::Conveyor::Value::Transaction::Necessity->new;
...
Data::Conveyor::Value::Transaction::Necessity inherits from
...
This document describes version 0.02 of L<Data::Conveyor::Value::Transaction::Necessity>.
