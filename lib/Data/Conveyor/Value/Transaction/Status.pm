...
# $Id: Status.pm 8442 2005-02-17 17:16:09Z gr $
...
sub get_valid_values_list { $_[0]->delegate->TXS }
...
sub send_notify_value_invalid {
    ...
    $self->exception_container->record(
        'Data::Conveyor::Exception::Transaction::NoSuchStatus',
        status => $value,
    );
}
...
Data::Conveyor::Value::Transaction::Status - stage-based conveyor-belt-like ticket handling system

=head1 SYNOPSIS

    Data::Conveyor::Value::Transaction::Status->new;
...
Data::Conveyor::Value::Transaction::Status inherits from
