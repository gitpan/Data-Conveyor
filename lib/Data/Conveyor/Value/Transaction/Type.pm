package Data::Conveyor::Value::Transaction::Type;

# $Id: Type.pm 8442 2005-02-17 17:16:09Z gr $
...
sub get_valid_values_list { $_[0]->delegate->TXT }
...
sub send_notify_value_invalid {
    ...
    $self->exception_container->record(
        'Data::Conveyor::Exception::Transaction::NoSuchType',
        type => $value,
    );
}
...
Data::Conveyor::Value::Transaction::Type - stage-based conveyor-belt-like ticket handling system

=head1 SYNOPSIS

    Data::Conveyor::Value::Transaction::Type->new;
...
Data::Conveyor::Value::Transaction::Type inherits from
...
This document describes version 0.02 of L<Data::Conveyor::Value::Transaction::Type>.
