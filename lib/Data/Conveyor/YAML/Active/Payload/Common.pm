...
use base 'Data::Conveyor::YAML::Active::Payload::Item';
...
=head1 SYNOPSIS
    ...
    Data::Conveyor::YAML::Active::Payload::Common->new;
...
Data::Conveyor::YAML::Active::Payload::Common inherits from
L<Data::Conveyor::YAML::Active::Payload::Item>.

The superclass L<Data::Conveyor::YAML::Active::Payload::Item> defines these
methods and functions:

    __payload_item(), __payload_item_clear(), clear___payload_item(),
    move_payload_item_property_from_hash(), populate_payload_item(),
    run_plugin()
...
functions:
    ...
    exists___hash(), get_args(), keys___hash(), values___hash()
...
This document describes version 0.02 of L<Data::Conveyor::YAML::Active::Payload::Common>.
