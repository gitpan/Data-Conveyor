...
=head1 SYNOPSIS
    ...
    Data::Conveyor::YAML::Active::Payload::Item->new;
...
=item __payload_item
    ...
    my $value = $obj->__payload_item;
    $obj->__payload_item($value);

A basic getter/setter method. If called without an argument, it returns the
value. If called with a single argument, it sets the value.

=item __payload_item_clear

    $obj->__payload_item_clear;
...
Data::Conveyor::YAML::Active::Payload::Item inherits from
L<Class::Scaffold::YAML::Active::Hash>.
...
This document describes version 0.02 of L<Data::Conveyor::YAML::Active::Payload::Item>.
